...
interface ConfirmTransactionDeletionProps {
  transaction: ITransaction;
  handleCloseDeleteTransactionModal: () => void;
}

export function ConfirmTransactionDeletion({ transaction, handleCloseDeleteTransactionModal }: ConfirmTransactionDeletionProps) {
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Você tem certeza que deseja deletar a transação <b>{transaction.title}</b>?
                      Se você deletar, não será possível reverter essa ação.
                    </p>
                  </div>
                </div>
              </div>
